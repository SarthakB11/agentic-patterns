...
![Multi-agent demo](../../docs/demos/multi_agent.gif)

_Recorded from `python3 -m patterns.multi_agent.main`, offline, no API key. Regenerate with `python3 tools/record_demos.py record-all`._
